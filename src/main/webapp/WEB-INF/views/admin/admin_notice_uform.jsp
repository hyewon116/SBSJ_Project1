	...
	<div class="container">
		...
		<main class="clearfix mt-1" style="height: 500px">
			...
			<section class="col-10 h-100 bg-white float-left">
				...
				<form id="write_form">
					...
					<table class="table table-boardered">
						<tbody>
							<tr>
								<th>제목</th>
								<td><input type="text" id="notice_title"
									name="notice_title" maxlength="40" class="form-control"
									value="${detail_dto.notice_title}"> <label
									for="notice_title" id="notice_title_label" class="write_label"></label>
								</td>
							</tr>
							...
							<tr>
								...
								<td><textarea id="notice_content" name="notice_content"
										class="form-control">${detail_dto.notice_content}</textarea> <script
										type="text/javascript">
						CKEDITOR.replace('notice_content');
						</script> <label for="notice_content" id="notice_content_label"
				...
				<div>
					<button id="update_btn" class="btn btn-info float-right">수정
						완료</button>
					<button class="btn btn-warning"
						onclick="location.href='${pageContext.request.contextPath}/admin/admin_notice_detail?notice_id=${detail_dto.notice_id}'">돌아가기</button>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#update_btn").click(function() {
			...
			$.post(
					"${pageContext.request.contextPath}/admin/admin_notice_update"
					, {
