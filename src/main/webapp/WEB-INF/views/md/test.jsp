	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#write_btn").click(function() {
				...
				const select1 = $('#md_category option:selected').val();
				const select2 = $('#md_sweet option:selected').val();
				const select3 = $('#md_sour option:selected').val();
				const select4 = $('#md_sparkling option:selected').val();
				form.append("md_category", select1);
				form.append("md_sweet", select2);
				form.append("md_sour", select3);
				form.append("md_sparkling", select4);
