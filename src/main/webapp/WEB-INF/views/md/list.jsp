		...
		<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
			...
			<body>
				...
				<div class="container">
					...
					<!-- 필터링 버튼 -->
					<div class="btn-group">
						<button type="button" class="btn text-black dropdown-toggle" style="background-color: tan;" data-toggle="dropdown">
							주종
						</button>
					...
					<ul class="pagination justify-content-center">
						<c:if test="${startPageNum > 10}">
							<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/md/list_cate?userWantPage=${startPageNum-1}">
									Previous
								</a>
								</li>
								</c:if>
								<c:forEach var="page_no" begin="${startPageNum}" end="${endPageNum}">
									<c:choose>
										...
										<c:if test="${lastPageNum > endPageNum}">
											<li class="page-item">
								<a class="page-link" href="${pageContext.request.contextPath}/md/list_cate?userWantPage=${endPageNum+1}">
									Next
								</a>
								</li>
								</c:if>
